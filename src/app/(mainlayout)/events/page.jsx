...
import { fetchEvents, fetchEventsQuery } from "@/lib/api/events/data";
...
const EventsPage = async ({ searchParams }) => {
  ...
  // MongoDB handles filtering now — no JS array filtering needed
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      {/* Filters — needs Suspense because useSearchParams is used inside */}
      <Suspense
        fallback={
          <div className="h-11 mb-8 rounded-xl bg-slate-900/40 animate-pulse" />
        }
      >
        <EventFilters />
      </Suspense>
